...
public class NoteActivity extends AppCompatActivity {
    ...
    public static final String NOTE_POSITION = "com.example.notelist.NOTE_POSITION";
    ...
    private void saveOriginalValue() {
        ...
        mViewModel.mOriginalNotesCoursseId = mNote.getCourse().getCourseId();
        mViewModel.mOriginalNoteTile = mNote.getTitle();
    ...
    private void storePreviousNoteValues() {
        CourseInfo course = DataManager.getInstance().getCourse(mViewModel.mOriginalNotesCoursseId);
        mNote.setCourse(course);
        mNote.setTitle(mViewModel.mOriginalNoteTile);
    ...
    private void sendEmail() {
        ...
        String text = "Check what learned \"" +
